...
function Card({
  ...
  const width = window.innerWidth < 768 ? 250 : 400;
  ...
  return (
    ...
    >
      ...
      {isBooked && (
        <div
          className="text-green-600 bg-white/90 backdrop-blur-md rounded-full absolute right-2 top-2 
      ...
      {popUp && (
        <div
          className="w-[260px] h-[110px] bg-white/95 backdrop-blur-lg absolute top-[110px] left-[10px] 
      ...
      <div className="w-full h-[65%] rounded-xl overflow-hidden">
        <div className="w-full h-full flex">
          ...
          />
          <img
            src={optimizeImage(image2, width)}
            loading="lazy"
            className="w-full flex-shrink-0 object-cover"
          />
          <img
            src={optimizeImage(image3, width)}
            loading="lazy"
            className="w-full flex-shrink-0 object-cover"
          />
        </div>
